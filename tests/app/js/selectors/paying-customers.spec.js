...
//       expect(
//         sumTotalForRange(data, range, 'payingCustomers')
//       ).toBeA('number')
//     })
//
//     // should throw is one of them is not valid
//
...
//     it('should take in Map, List and string', () => {
//       const call = {
//         getTotalsByDatesInRange,
//       }
//
...
//
//       call.getTotalsByDatesInRange(data, array, 'payingCustomersData')
//
//       expect(getTotalsByDatesInRange.bind(null, data, array)).toThrow('missing arguments')
//       expect(getTotalsByDatesInRange.bind(null, data, array, 1)).toThrow('invalid endpoint type')
//       expect(getTotalsByDatesInRange.bind(null, data, 'array', '1')).toThrow('invalid list of dates type')
//       expect(getTotalsByDatesInRange.bind(null, 'data', array, '1')).toThrow('invalid data type')
//
//       expect(spy.calls[0].arguments.length).toBe(3)
//       expect(spy.calls[0].arguments[0]).toBeA(Map)
//       expect(spy.calls[0].arguments[1]).toBeA(List)
//       expect(spy.calls[0].arguments[2]).toBeA('string')
//     })
//
//
...
//       const array = getDatesInRange(from, to)
//
//       const result = getTotalsByDatesInRange(data, array, 'payingCustomersData')
//
