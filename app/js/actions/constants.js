...
export const SET_FILTER_COMPONENT_MENU_STATE: string = 'SET_FILTER_COMPONENT_STATE'
export const RESET_FILTER_COMPONENT_STATE: string = 'RESET_FILTER_COMPONENT_STATE'

export const OVERLAY_CLOSED: string = 'OVERLAY_CLOSED'
